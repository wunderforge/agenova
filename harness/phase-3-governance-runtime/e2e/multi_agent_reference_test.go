// Package e2e contains the multi-agent reference scenario for Phase 3 governance.
...
func TestMultiAgentReference(t *testing.T) {
	...
	// --- Phase 1: start all three claims ---
	...
	// --- Phase 2: each claim invokes through the gateways ---
	...
	// --- Phase 3: verify facts are isolated per claim ---
	...
	// --- Phase 5: terminate orchestrator; workers become out-of-scope ---
