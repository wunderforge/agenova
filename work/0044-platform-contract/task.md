...
- Mission: Define one versioned, backend-neutral `Platform` desired-state contract that later install, bootstrap, CLI and UI work can share.
...
- [ ] Add Platform/lock types and strict YAML/JSON parsing without provider imports.
