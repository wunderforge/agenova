...
const (
	...
	CategoryAuthorityUnavailable   = "authority-unavailable"
	CategoryToolNotGranted         = "tool-not-granted"
	CategoryResourceNotGranted     = "resource-scope-not-granted"
	CategoryModelProfileNotGranted = "model-profile-not-granted"
	CategoryOutOfParentScope       = "out-of-parent-scope"
	CategoryInvalidPolicyOutcome   = "invalid-policy-outcome"
	CategoryGatewayUnavailable     = "gateway-unavailable"
)
